...
?>
  ...
  <form method="post" action="">
    ...
    document.getElementById('day').value = "<?php echo $birth_day;?>";
  </script>
      ...
      <select  name="month" id="month" class="form-control">
        ...
        <script type="text/javascript">
    document.getElementById('month').value = "<?php echo $birth_month;?>";
  </script>
      ...
      <select  name="year" id="year" class="form-control">
        ...
        <script type="text/javascript">
    document.getElementById('year').value = "<?php echo $birth_year;?>";
  </script>

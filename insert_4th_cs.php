...
<?php
$student_id = $name = $year = $sub1 = $sub2 = $sub3 = $sub4 = $sub5 = $sub6 = $sub7 = $sub8 = $sub9 = $sub10 = $proj = $grade = $percentage = "";
$Err = $student_idErr = $nameErr = $yearErr = $sub1Err = $sub2Err = $sub3Err = $sub4Err = $sub5Err = $sub6Err = $sub7Err = $sub8Err = $sub9Err = 
$sub10Err = $projErr = $gradeErr = $percentageErr = "";
  ...
  <table class="table ">
    ...
    <tbody>
      <tr>
        ...
        <td><input type="number" class="form-control" name="percentage" value="<?php echo $percentage;?>" max="100.00" step=".01" required>
            <span class="error"> <?php echo $percentageErr;?></span></td>
      </tr>
...
$sql = "INSERT INTO 4th_cs (student_id, name, year, `1`, `2`, `3`, `4`, `5`, `7`, `8`, `9`, `10`, `11`, `12`, `13`, `14`)
VALUES 
('$student_id', '$name', '$year', '$sub1', '$sub2', '$sub3', '$sub4', '$sub5', '$sub6', '$sub7', '$sub8', '$sub9', '$sub10', '$proj', '$grade', 
  '$percentage')";
